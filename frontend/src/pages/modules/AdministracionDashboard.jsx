          ...
          >
            <div className="flex items-center space-x-4 mb-4">
              <div className="p-3 rounded-lg bg-orange-600">
                {" "}
                {/* Color del módulo Administración */}
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Crear, ver y gestionar requisiciones de material, equipo o
              servicio.
            </p>
          </Link>
          <Link
            to="/unebi/gestion-claves"
            className="group block p-6 bg-white dark:bg-gray-800/50 rounded-lg shadow-md hover:shadow-lg dark:shadow-black/30 hover:-translate-y-1 transition-transform border border-gray-200 dark:border-gray-700/50 hover:border-blue-500 hover:dark:border-blue-500 "
          >
            <div className="flex items-center space-x-4 mb-4">
              <div className="p-3 rounded-lg bg-orange-600">
